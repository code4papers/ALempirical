...
select_index = np.load("../data/IMDB_lstm_selected_index.npy")
model = load_model("../../new_models/RQ1/IMDB/EGL_lstm_ori.h5")
maxlen = 200
max_features = 20000
...
results_path = "../../new_results/RQ1/IMDB/EGL_lstm.csv"
...
try:
    ...
    csv_file.close()
model.save("../../new_models/RQ1/IMDB/EGL_lstm_ori.h5")
