...
def NiN_al(model, windows):
    ...
    remain_index = np.load("../data/IMDB_lstm_remain_data.npy")
    ...
    np.save("../data/IMDB_lstm_selected_index.npy", now_select)
    np.save("../data/IMDB_lstm_remain_data.npy", now_remain)
...
if __name__ == '__main__':
    ...
    if mode == 0:
        ...
        model = keras.models.load_model("../../new_models/RQ1/IMDB/EGL_lstm_ori.h5")
