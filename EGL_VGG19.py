...
def wideresnet_al(model, windows):
    ...
    remain_index = np.load("VGG19/data/remain_data.npy")
    ...
    np.save("VGG19/data/selected_index.npy", now_select)
    np.save("VGG19/data/remain_data.npy", now_remain)
...
if __name__ == '__main__':
    ...
    if mode == 0:
        ...
        model = keras.models.load_model("VGG19/models/EGL_VGG19.h5")
