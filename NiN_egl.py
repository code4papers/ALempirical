...
def NiN_al(model, windows):
    ...
    remain_index = np.load("../data/NiN_remain_data.npy")
    ...
    np.save("../data/NiN_selected_index.npy", now_select)
    np.save("../data/NiN_remain_data.npy", now_remain)
...
if __name__ == '__main__':
    ...
    if mode == 0:
        ...
        model = keras.models.load_model("../../new_models/RQ1/NiN/EGL_for_at.h5")
