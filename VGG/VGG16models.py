...
def train_VGG16(num, num_epoch=200, batchSize=128, **kwargs):
    nb_class = 10
    ...
    bestmodelname = "../../new_models/RQ1/VGG16/VGG16_" + str(num) + ".h5"
    ...
    # print("acc: ", his.history['val_accuracy'])
...
def VGG16_clipped_dropout(input_shape=None, rate=0.2, nb_classes=10, drop=False):
    # Block 1
