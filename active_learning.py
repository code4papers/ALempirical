...
def Cifar10_al(model, steps,  windows, epochs, results_path, metric, model_save_path, dropout_model=None, data_aug=True):
    ...
    np.save("../../data/selected_data/NiN/" + str(metric) + "_x_selected.npy", training_data)
    np.save("../../data/selected_data/NiN/" + str(metric) + "_y_selected.npy", training_label)
    # np.save("../../data/selected_data/NiN/" + str(strategy) + "_x_remain.npy", target_data)
    # np.save("../../data/selected_data/NiN/" + str(strategy) + "_y_remain.npy", y_train)
