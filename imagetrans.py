...
if __name__ == "__main__":
    ...
    if data == 'test':
        ...
        # y_test = to_categorical.to_categorical(y_test, 10)
    ...
    if data == 'mnist':
        ...
        np.save("data/mnist_contrast.npy", x_save)
        # model_path = "models/lenet-5.h5"
    ...
    if data == 'cifar':
        ...
        for i in range(len(x_test)):
            ...
            #     saveorigin_image(x_test[i], i)
        np.save("data/cifar_translation.npy", x_save)
