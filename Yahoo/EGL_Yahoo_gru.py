...
def NiN_al(model, windows):
    ...
    remain_index = np.load("../data/Yahoo_gru_remain_data.npy")
    ...
    np.save("../data/Yahoo_gru_selected_index.npy", now_select)
    np.save("../data/Yahoo_gru_remain_data.npy", now_remain)
...
if __name__ == '__main__':
    ...
    if mode == 0:
        ...
        model = keras.models.load_model("../../new_models/RQ1/Yahoo/EGL_gru_ori.h5")
