...
threshold = 0.86
select_index = np.load("../data/Yahoo_gru_selected_index.npy")
model = load_model("../../new_models/RQ1/Yahoo/EGL_gru_ori.h5")
...
print("#####################################")
check_point = ModelCheckpoint("../../new_models/RQ1/Yahoo/EGL_gru_ori.h5", monitor="val_accuracy", save_best_only=True, verbose=1)
...
results_path = "../../new_results/RQ1/Yahoo/EGL_gru.csv"
